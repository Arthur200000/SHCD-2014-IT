...
﻿namespace Qisi.Editor.Expression
{
    ...
    internal class type5 : imageexpression
    {
        ...
        public override void RefreshRegion(Graphics g)
        {
            ...
            float width = base.GSize.Width + this.Xiabiao.Region.Width;
            float height = Math.Max((float) (base.GSize.Height + (this.Xiabiao.Region.Height / 2f)), (float) ((base.GSize.Height / 2f) + this.Xiabiao.Region.Height));
