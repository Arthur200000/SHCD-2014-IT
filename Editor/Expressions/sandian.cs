...
﻿namespace Qisi.Editor.Expression
{
    ...
    internal class sandian : dexpression
    {
        ...
        public override void DrawExpression(Graphics g)
        {
            ...
            g.FillEllipse(brush, (base.Benti.InputLocation.X + (base.Benti.Region.Width / 2f)) - ((base.DotWidth / 2f) * 5f), ((base.InputLocation.Y + (base.Region.Height / 4f)) - (base.Benti.Region.Height / 4f)) - (base.DotWidth / 2f), base.DotWidth, base.DotWidth);
