    ...
    internal class hanshuxiabiao : structexpression
    {
        ...
        public override void RefreshInputLocation()
        {
            ...
            if (this.Xiabiao.Region.Width < this.Hanshu.Region.Width)
            {
                ...
                num = ((base.InputLocation.X + 2f) + this.Hanshu.Region.Width) + 5f;
            }
            else
            {
                ...
                num = ((base.InputLocation.X + 2f) + this.Xiabiao.Region.Width) + 5f;
            }
            this.Benti.InputLocation = new PointF(num, (base.InputLocation.Y + base.BaseLine) - this.Benti.BaseLine);
        ...
        public override void RefreshRegion(Graphics g)
        {
            ...
            float height = Math.Max(this.Hanshu.BaseLine, this.Benti.BaseLine) + Math.Max((float) ((this.Hanshu.Region.Height + this.Xiabiao.Region.Height) - this.Hanshu.BaseLine), (float) (this.Benti.Region.Height - this.Benti.BaseLine));
        ...
        {
            return (@"\" + this.Hanshu.ToString() + "^{" + this.Xiabiao.ToString() + "}{" + this.Benti.ToString() + "}");
        }
